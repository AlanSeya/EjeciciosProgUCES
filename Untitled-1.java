...
/*Ejercicio 1: Contar la cantidad de palabras que
comienzan con una letra específica
Enunciado: Escribí un programa que cuente la
cantidad de palabras en un array de Strings que
comienzan con una letra específica. */

      String[] palabras = {"jepe", "jose", "julieta", "belen", "alan", "juan"};
      char caracter = 'j';
      ...
      System.out.println("La cantidad de palabras que comienzan con la letra 'j' es: " + contadorPalabra);

  /*Ejercicio 2: Encontrar la palabra más larga en un
array de Strings
Enunciado: Escribe un programa que encuentre la
palabra más larga en un array de Strings. */
  
String[] palabras = {"Hola", "Programación", "Java", "Desarrollo", "OpenAI"};

String palabraLarga= palabra [0];
for (int i= 1; i< palabras.length; i++){
  if (palabras[i].length() )
}
